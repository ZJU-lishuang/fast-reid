...
class CarAttr(Dataset):
    ...
    def __init__(self, root='', **kwargs):
        ...
        super(CarAttr, self).__init__(train, val, test, attr_dict=[attr_dict1,attr_dict2], **kwargs)
    ...
    def extract_data(self):
        ...
        data = []
        for i in range(n):
            attrs1 = self.labels[i][0]
            attrs2 = self.labels[i][1]
            img_path = self.img_files[i]
            data.append((img_path, np.array([attrs1,attrs2])))
